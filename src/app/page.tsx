import MenuSection from "./(home)/MenuSectionNew";
import HeroSection from "./(home)/HeroSection";
import ChainSection from "./(home)/ChainSection";
import BurgerSection from "./(home)/BurgerSection";
  ...
  return (
    <div className="relative h-full w-full">
      <div className=" overflow-hidden">
        ...
        <div className=" bg-[radial-gradient(ellipse_at_80%_36%,_#5b0000_0%,_#000000_50%)]">
          <Header />
          <HeroSection />
          <BurgerSection />
          <MenuSection />
